  ...
  return (
    <footer className="border-t border-border-rule py-8 px-6 md:px-10">
      <div className="max-w-[900px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        {/* Left */}
        <div className="text-[12px] text-ink-tertiary" style={{ fontFamily: 'var(--font-ui)' }}>
        ...
        <div className="flex items-center gap-4">
          <a
            href="https://github.com/JiaWeiTeh/trinity"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="TRINITY source code on GitHub"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="TRINITY documentation"
            className="text-ink-tertiary hover:text-ink-primary transition-colors duration-150"
          >
        ...
        {/* Right */}
        <div className="text-[12px] text-ink-tertiary opacity-60" style={{ fontFamily: 'var(--font-ui)' }}>
          Built with TRINITY
        </div>
      </div>
    </footer>
